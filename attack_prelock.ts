...
echo ansi_14 "1." ansi_15 " figs_per_wave: " ansi_9 "[" ansi_6 $figs ansi_9 "]*"
echo ansi_14 "2." ansi_15 " number_waves : " ansi_9 "[" ansi_6 $num_waves ansi_9 "]*"
...
elseif ($choice = "2")
  ...
  getConsoleInput $num_waves
  echo "[2J"
  goto :ansimenu
elseif ($choice = "c")
  if ($figs = 0) OR ($num_waves = 0)
    echo "[2J"
    goto :ansimenu
  else
    goto :update_clv
